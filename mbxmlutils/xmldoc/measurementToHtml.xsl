...
<p>Storing data for the lifetime of the instance of this class is, except the deprecated "addNewVarsToInstance" action, not possible by design for now.</p>
    ...
    <footer>
      <ul class="list-group">
        ...
        <li id="fn02">[2] the condition (<code>c&gt;=0</code>) can contain <code>True</code>, <code>False</code>, <code>&gt;</code>, <code>&gt;=</code>, <code>&lt;</code>, <code>&lt;=</code>, <code>&amp;</code> and <code>|</code>. The condition is then converted accordingly. If none of the conditions evaluates to True, 0 is used (python uses None in this case).</li>
