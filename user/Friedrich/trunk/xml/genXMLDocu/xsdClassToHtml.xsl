<xsl:stylesheet
  ...
  xmlns:mm="http://www.amm.mw.tu-muenchen.de/XXX/physicalvariable"
...
<!--  <xsl:template match="/xs:schema/xs:complexType/xs:attribute">
  ...
  <xsl:template mode="SIMPLECONTENT" match="xs:element">
    ...
    <li>
      ...
      <!-- type -->
      <xsl:if test="@type">
        <!-- type {http://www.amm.mw.tu-muenchen.de/XXX/physicalvariable}* -->
        <xsl:if test="namespace-uri-from-QName(resolve-QName(@type,.))='http://www.amm.mw.tu-muenchen.de/XXX/physicalvariable'">
          (Type: <a style="font-family:monospace">
        ...
        <!-- type not {http://www.amm.mw.tu-muenchen.de/XXX/physicalvariable}* -->
        <xsl:if test="namespace-uri-from-QName(resolve-QName(@type,.))!='http://www.amm.mw.tu-muenchen.de/XXX/physicalvariable'">
