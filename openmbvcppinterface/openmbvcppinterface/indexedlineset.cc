...
OPENMBV_OBJECTFACTORY_REGISTERXMLNAME(IndexedLineSet, OPENMBV%"IndexedLineSet")

DOMElement* IndexedLineSet::writeXMLFile(DOMNode *parent) {
...
void IndexedLineSet::initializeUsingXML(DOMElement *element) {
